...
class Biometria extends StatelessWidget {
          ...
          if (snapshot.data == true) {
            return Padding(
              ...
              child: Column(
                children: [
                  Text(
                    'Detectamos que você tem sensor biométrico no seu smartphone, '
                    'deseja cadastrar o acesso biométrico',
  ...
  Future<void> _autenticarCliente(context) async {
    ...
    autenticado = await _autenticacaoLocal.authenticate(
      localizedReason:
          'Por favor, autentique-se via biometria para utenticar no bytebank',
